...
$(document).on('ready', function() {
  ...
  $('#lists').sortable({
    ...
    placeholder: {
      element: function(item) {
          return $(
          `<div class="shadow" style="width: ${item.css('width')}; height: ${item.css('height')}; background: rgba(0,0,0,0.2)">
          </div>`
          )[0];
      },
  ...
  // // COLLABS
  // var $gallery = $( "#collabs-section" ), $trash = $( ".collaborators" );
